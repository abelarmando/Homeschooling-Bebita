...
export const jenis_kelas = [
  {
    ...
    img: "./images/GAMBAR_ONLINE_DAN_HIBRIDA_CLASS_R1.png",
  },
  {
    judul: "Reguler Class",
    deskripsi:
  ...
  },
  {
    ...
    img: "./images/GAMBAR_WORKING_CLASS.png",
  },
];
...
export const review_students = [
  {
    nama: "Jason Jorge (alumni)",
    review:
      "Belajar di Homeschooling Bebita sangat menyenangkan! Kakak guru sabar dan materi mudah dipahami.",
    img: "./images/students/GAMBAR_PENILAIAN_JASON.png",
  },
  {
    nama: "Ratna Wulan Dari (alumni)",
    review:
      "Awalnya susah fokus, tapi sekarang jadi lebih semangat belajar. Lingkungan belajarnya nyaman dan fleksibel.",
    img: "./images/students/GAMBAR_PENILAIAN_RATNA_WULAN_DARI.png",
  },
  {
...
export const activity_students = [
  { name: "Ujian", img: "./images/Ujian.jpg" },
  { name: "Lomba", img: "./images/Lomba.jpg" },
  { name: "Hari 17 Agustus", img: "./images/Hari_17_Agustus.jpg" },
];
